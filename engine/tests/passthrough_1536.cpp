...
// -----------------------------------------------
// Configuration
// FRAMES=1536 gives Python 34.8ms per chunk
// which is enough time for DeepFilterNet (~25ms)
// Device 1+4 MME mono — confirmed working
// -----------------------------------------------
constexpr int SAMPLE_RATE   = 44100;
constexpr int FRAMES        = 1536; // 34.8ms per chunk
constexpr int CHANNELS      = 1;    // mono for both
...
// -----------------------------------------------
int main() {
    std::cout << "=== Passthrough Test — FRAMES=1536 ===\n";
    std::cout << "Purpose: verify audio pipeline with correct\n";
    std::cout << "         buffer size before adding AI\n\n";
    ...
    std::cout << "Phase 1 — Passthrough: you hear yourself directly\n";
    std::cout << "Phase 2 — With Python: noise will be cancelled\n\n";
    ...
    std::thread senderThread([&]() {
        while (running) {
            ...
            // Sleep exactly one chunk period
            // This matches Python's processing time
    ...
    std::cout << "Dropped:  " << sentCount - receivedCount << " chunks\n";
    std::cout << "Drop rate: "
